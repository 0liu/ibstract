...
**Data pre-existing** in MySQL database:
  .. image:: ./examples/readme_example1_data_in_db.png
...
**Output data** is the combination of those in database and downloaded:
  .. image:: ./examples/readme_example1_data_output.png
...
.. |Status| image:: https://img.shields.io/badge/status-develop-orange.svg
